...
<body class="bg-slate-900 flex flex-col justify-center items-center min-h-full">
  ...
  <p class="text-slate-400 text-lg text-center mt-4">
    Your status is unLogged, <br>
    please Login or Register first
  </p>
  <div class="flex text-slate-500 mt-4 gap-16">
    <a href="<?= BASE_URL ?>/auth/login/" class="hover:text-slate-300 duration-200">Login</a>
    <a href="<?= BASE_URL ?>/auth/register/" class="hover:text-slate-300 duration-200">Register</a>
  </div>
</body>
</html>